...
interface SyncVisualizerToolbarProps {
  concerts: Concert[];
...
export const SyncVisualizerToolbar: React.FC<SyncVisualizerToolbarProps> = ({
  concerts,
  selectedConcertId,
  loading,
  isAdminMode,
  ...
  return (
    <>
      {/* Top Header Row with Concert Selector & Action Toolbar */}
